...
class FDI implements ArrayAccess
{
    ...
    {
        echo '[TEST TRACE]', "FDI::__call($name)\n";
    ...
    {
        echo '[TEST TRACE]', "FDI::__set($name)\n";
        $this->set($name, $value);
    }

    public function __get($name)
    {
        echo '[TEST TRACE]', "FDI::__get($name)\n";
    ...
    {
        echo '[TEST TRACE]', "FDI::offsetSet($offset)\n";
        $this->set($offset, $value);
    }

    public function offsetGet($offset)
    {
        echo '[TEST TRACE]', "FDI::offsetGet($offset)\n";
        return $this->get($offset);
    }

    public function offsetUnset($offset)
    {
        echo '[TEST TRACE]', "FDI::offsetUnset($offset)\n";
        unset($this->_data[$offset]);
    }

    public function offsetExists($offset)
    {
        echo '[TEST TRACE]', "FDI::offsetExists($offset)\n";
